#
#  Be sure to run `pod spec lint LHCategoryTool.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "MeanMouse"
  # s.authors            = { "MeanMouse" => "1871382624@qq.com" }
  # s.social_media_url   = "http://twitter.com/MeanMouse"
  ...
  s.source_files  = "LHCategoryTool", "LHCategoryTool/**/*.{h,m}"
